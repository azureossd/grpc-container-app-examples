...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.grpc.server.Empty,
      com.grpc.server.HelloReply> getGreetingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Greeting",
      requestType = com.grpc.server.Empty.class,
      responseType = com.grpc.server.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.grpc.server.Empty,
      com.grpc.server.HelloReply> getGreetingMethod() {
    io.grpc.MethodDescriptor<com.grpc.server.Empty, com.grpc.server.HelloReply> getGreetingMethod;
    if ((getGreetingMethod = GreeterGrpc.getGreetingMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getGreetingMethod = GreeterGrpc.getGreetingMethod) == null) {
          GreeterGrpc.getGreetingMethod = getGreetingMethod =
              io.grpc.MethodDescriptor.<com.grpc.server.Empty, com.grpc.server.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Greeting"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpc.server.Empty.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpc.server.HelloReply.getDefaultInstance()))
  ...
  public static abstract class GreeterImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void greeting(com.grpc.server.Empty request,
        io.grpc.stub.StreamObserver<com.grpc.server.HelloReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.grpc.server.Empty,
                com.grpc.server.HelloReply>(
  ...
  public static final class GreeterBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreeterBlockingStub> {
     ...
     * </pre>
     */
    public com.grpc.server.HelloReply greeting(com.grpc.server.Empty request) {
  ...
  public static final class GreeterFutureStub extends io.grpc.stub.AbstractFutureStub<GreeterFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.grpc.server.HelloReply> greeting(
        com.grpc.server.Empty request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREETING:
          serviceImpl.greeting((com.grpc.server.Empty) request,
              (io.grpc.stub.StreamObserver<com.grpc.server.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.grpc.server.GreeterProto.getDescriptor();
    }
